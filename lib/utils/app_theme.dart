...
import 'package:practical/common/enums/font_type.dart';
...
class AppThemeState extends State<AppTheme> {
  ...
  TextStyle textStyleLight(Color color,
      {double fontSize = 12, TextDecoration? decoration}) {
    return TextStyle(
        decoration: decoration,
        fontWeight: FontType.getFontWeightType(FWT.light),
        fontFamily: FontType.getFontFamilyType(FFT.roboto),
        fontSize: fontSize.sp,
        color: color);
  }

  TextStyle textStyleMedium(Color color,
      {double fontSize = 12, TextDecoration? decoration}) {
    return TextStyle(
        decoration: decoration,
  ...
  TextStyle textStyleSemiBold(Color color,
      {double fontSize = 12, TextDecoration? decoration}) {
    return TextStyle(
        decoration: decoration,
  ...
  static OutlineInputBorder enableBorderStyle() {
  ...
  static OutlineInputBorder disabledBorderStyle() {
    return OutlineInputBorder(
      borderRadius: BorderRadius.circular(5.0),
  ...
  static OutlineInputBorder focusBorderStyle() {
    return OutlineInputBorder(
        borderRadius: BorderRadius.circular(5.0),
        borderSide: BorderSide(
          color: ColorConstants.primaryColor,
